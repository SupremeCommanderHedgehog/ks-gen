...
def gen(
    ...
    # phase 4 introduces a user-data lint. alma8/alma10 produce a ks.cfg with
    # the same shape as alma9, so the same lint applies.
    if bundle.distro in ("alma9", "alma8", "alma10"):
